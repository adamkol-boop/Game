...
def used_cards(chosen_cards):
    ...
    if cards_num == 1:
        ...
        card_w = 691/(cards_num + 2)
        card_h = 1056/(cards_num + 2)
...
def pick_dl():
    ...
    while not chose:
        ...
        #mx1, my1 = pygame.mouse.get_pos()
                ...
                print(f'x: {mx1}, y: {my1}')
                if mx1 > 790 and mx1 < 920 and my1 > 245 and my1 < 440:
                    print("mouse on stack")
                    if not is_stack_big:
                        draw_stack(5, bigger=True)
                        is_stack_big = True
